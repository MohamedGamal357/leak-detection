<template>
  <div
    class="base-modal px-3 bg-[#00000083] flex items-center justify-center fixed top-0 left-0 w-screen h-screen z-[1007]"
    :class="modalClass"
    @click="close"
  >
    <div
      ...
      @click.stop
    >
    <div class="bg-website_white p-5 top_header" v-if="!hideHeader">
      ...
      <p v-if="description" class="text-third">{{description}}</p>
    </div>
